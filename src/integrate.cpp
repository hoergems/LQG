...
m(2, 1) = M_inv_(0, 0)*(0.5*x[2]*x[3]*cos(x[1]) + x[3]*(0.5*x[2]*cos(x[1]) + 0.5*x[3]*cos(x[1]))) - 0.5*M_inv_(0, 1)*g_*sin(x[1]) - 0.5*M_inv_(0, 1)*pow(x[2], 2)*cos(x[1]); 
m(2, 2) = -M_inv_(0, 0)*viscous_[0] + M_inv_(0, 0)*(0.01*x[2]*sin(2*x[0]) + 1.0*x[3]*sin(x[1])) + M_inv_(0, 1)*(-x[2]*(-0.01*sin(2*x[0]) + 0.5*sin(x[1])) + x[2]*(0.01*sin(2*x[0]) - 0.5*sin(x[1])) + 0.01*x[3]*sin(2*x[0])); 
m(2, 3) = M_inv_(0, 0)*(1.0*x[2]*sin(x[1]) + x[3]*(-0.005*sin(2*x[0]) + 0.5*sin(x[1])) - x[3]*(0.005*sin(2*x[0]) - 0.5*sin(x[1]))) - M_inv_(0, 1)*viscous_[1] + 0.01*M_inv_(0, 1)*x[2]*sin(2*x[0]); 
...
m(3, 1) = M_inv_(1, 0)*(0.5*x[2]*x[3]*cos(x[1]) + x[3]*(0.5*x[2]*cos(x[1]) + 0.5*x[3]*cos(x[1]))) - 0.5*M_inv_(1, 1)*g_*sin(x[1]) - 0.5*M_inv_(1, 1)*pow(x[2], 2)*cos(x[1]); 
m(3, 2) = -M_inv_(1, 0)*viscous_[0] + M_inv_(1, 0)*(0.01*x[2]*sin(2*x[0]) + 1.0*x[3]*sin(x[1])) + M_inv_(1, 1)*(-x[2]*(-0.01*sin(2*x[0]) + 0.5*sin(x[1])) + x[2]*(0.01*sin(2*x[0]) - 0.5*sin(x[1])) + 0.01*x[3]*sin(2*x[0])); 
m(3, 3) = M_inv_(1, 0)*(1.0*x[2]*sin(x[1]) + x[3]*(-0.005*sin(2*x[0]) + 0.5*sin(x[1])) - x[3]*(0.005*sin(2*x[0]) - 0.5*sin(x[1]))) - M_inv_(1, 1)*viscous_[1] + 0.01*M_inv_(1, 1)*x[2]*sin(2*x[0]); 
return m; 
